...
export function activate(context: vscode.ExtensionContext) {
	...
	console.log('Congratulations, your extension "mybatis-jump-mapper-xml" is now active!');

	// The command has been defined in the package.json file
	// Now provide the implementation of the command with registerCommand
	// The commandId parameter must match the command field in package.json
	const disposable = vscode.commands.registerCommand('mybatis-jump-mapper-xml.helloWorld', () => {
	...
	const goToMybatisDefinition = vscode.commands.registerCommand('mybatis-jump-mapper-xml.goToMybatisDefinition', async () => {
